...
def main() -> None:
    ...
    vectordb_server_url = env.get("VECTORDB_SERVER_URL") or env.get("QDRANT_URL")
    embed_rerank_url = env.get("EMBED_RERANK_URL") or env.get("EMBED_URL")
    cml_token = env.get("CDSW_APIV2_KEY", "")
