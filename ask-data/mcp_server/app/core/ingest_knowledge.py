...
def build_ingest_config(backend_dir, env=None):
    """Resolve document, Qdrant, and embed-rerank settings explicitly from environment."""
...
def run_auto_ingest(
    ...
    for pdf_file in pdf_files:
        ...
        try:
            ...
            vector_embeddings, _ = get_embeddings(text_fragments, embed_rerank_url, cml_token or "", timeout=120.0)
