...
# --- PATH CONFIGURATION ---
CUBE_YAML_PATH = os.path.join(_ASK_DATA_ROOT, "cube_service", "model", "cubes", "bni_cube_definitions.yaml")
CUBE_VALUE_MAPPINGS_JSON_PATH = os.path.join(_ASK_DATA_ROOT, "data", "bni_cube_value_mappings.json")
