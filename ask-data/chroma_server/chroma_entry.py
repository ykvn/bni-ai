...
def main() -> None:
    ask_data_root = bootstrap_service("chroma")
    server_dir = Path(__file__).resolve().parent if "__file__" in globals() else ask_data_root / "chroma_server"
    ...
    data_path = resolve_data_path("CHROMA_DATA_PATH", "/home/cdsw/ask-data/chroma_server/chroma_db")
...
"""
    ...
    keep_alive_monitor(proc, start_proc, "ChromaDB")
